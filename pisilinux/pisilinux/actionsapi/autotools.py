...
from pisilinux.actionsapi.shelltools import can_access_file
from pisilinux.actionsapi.shelltools import unlink
from pisilinux.actionsapi.libtools import gnuconfig_update
from pisilinux.actionsapi.shelltools import isDirectory
from pisilinux.actionsapi.shelltools import ls
from pisilinux.actionsapi.pisilinuxtools import dosed
from pisilinux.actionsapi.pisilinuxtools import removeDir
...
class RunTimeError(pisilinux.actionsapi.Error):
    def __init__(self, value=''):
        pisilinux.actionsapi.Error.__init__(self, value)
        self.value = value
        ctx.ui.error(value)
