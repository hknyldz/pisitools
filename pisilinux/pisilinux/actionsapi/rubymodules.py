...
__trans = translation('pisilinux', fallback=True)
_ = __trans.ugettext
...
from pisilinux.actionsapi.shelltools import export
from pisilinux.actionsapi.shelltools import isEmpty
...
class CompileError(pisilinux.actionsapi.Error):
    def __init__(self, value=''):
        pisilinux.actionsapi.Error.__init__(self, value)
        self.value = value
        ctx.ui.error(value)
...
def auto_dodoc():
    from pisilinux.actionsapi.pisilinuxtools import dodoc
