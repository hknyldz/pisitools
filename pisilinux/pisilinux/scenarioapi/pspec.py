...
from pisilinux.specfile import SpecFile, Package, Update, Path, Action, Archive, AnyDependency
from pisilinux.dependency import Dependency
from pisilinux.conflict import Conflict
from pisilinux.pxml.autoxml import LocalText
