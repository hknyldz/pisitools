...
usage = _("""Build pisilinux packages

Usage: build [<pspec.xml> | <sourcename>] ...

You can give a URI of the pspec.xml file. pisilinux will
...
class Build(command.Command, metaclass=command.autocommand):
    ...
    def add_options(self, group):
        group.add_option("-q", "--quiet",
                         action="store_true",
                         default=False,
                         help=_("Run pisilinux build operation without printing "
    ...
    def add_steps_options(self):
        ...
        group.add_option("--package",
                         ...
                         action="store_const",
                         const="package",
                         help=_("Create pisilinux package"))
    ...
    def run(self):
        ...
        for x in self.args or ["pspec.xml"]:
            if ctx.get_option('until'):
                pisilinux.api.build_until(x, ctx.get_option('until'))
            else:
                pisilinux.api.build(x)
